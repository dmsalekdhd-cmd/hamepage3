...
const outdoorHighlights = [
  ...
  { imageUrl: 'https://images.unsplash.com/photo-1582719508461-905c673771fd?auto=format&fit=crop&w=400&q=80', name: '미끄럼틀', desc: '짜릿한 워터슬라이드', color: 'from-orange-50 to-amber-100', border: 'border-orange-200' },
  { imageUrl: 'https://images.unsplash.com/photo-1516690561799-46d8f74f9abf?auto=format&fit=crop&w=400&q=80', name: '영유아풀', desc: '안전한 아이 전용 풀', color: 'from-teal-50 to-sky-100', border: 'border-teal-200' },
];
